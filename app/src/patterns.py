    ...
    "debate-critic": Pattern(
        ...
        roles=[
            AgentRole(
                ...
                system_prompt=(
                    "당신은 토론의 '찬성' 측 발언자입니다. "
                    "주어진 주제에 대해 강력한 논거를 제시하세요. "
                    "논리적 근거와 구체적 사례를 포함하세요."
                ),
            ),
            AgentRole(
                name="Opponent",
                ...
                system_prompt=(
                    "당신은 토론의 '반대' 측 발언자입니다. "
                    "찬성 측의 약점을 파악하고 반론을 제시하세요. "
                    "비판적 사고로 논거의 허점을 드러내세요."
                ),
            ),
            AgentRole(
                name="Critic",
                ...
                system_prompt=(
                    "당신은 중립적 평가자입니다. "
                    "찬성과 반대 양측의 논거를 객관적으로 분석하세요. "
                    "각 논거의 강점과 약점을 공정하게 평가하세요."
                ),
            ),
            AgentRole(
                name="Synthesizer",
                ...
                system_prompt=(
                    "당신은 토론 종합자입니다. "
                    "양측의 논거가 수렴했는지 판단하세요. "
                    "충분히 수렴했다면 'CONVERGED'를, "
                    "아니라면 'CONTINUE'를 출력하고 이유를 설명하세요."
                ),
            ),
            AgentRole(
                name="Scribe",
        ...
        roles=[
            ...
            AgentRole(
                ...
                system_prompt=(
                    ...
                    "제출된 결과물을 엄격하게 평가하세요. "
                    "품질이 충분하면 'PASS'를, "
                    "개선이 필요하면 'FAIL'과 함께 구체적 피드백을 제공하세요."
                ),
            ),
            AgentRole(
                name="Refiner",
    ...
    "leadership": Pattern(
        ...
        roles=[
            AgentRole(
                ...
                system_prompt=(
                    "당신은 CEO입니다. "
                    "전략적 의사결정을 위한 안건을 설정하고, "
                    "모든 브리핑을 종합하여 최종 결정을 내리세요."
                ),
            ),
            AgentRole(
                name="CTO",
    ...
    "planner-executor": Pattern(
        ...
        roles=[
            AgentRole(
                ...
                system_prompt=(
                    "당신은 계획 수립자입니다. "
                    "주어진 작업을 분석하고 단계별 실행 계획을 수립하세요. "
                    "각 단계의 수용 기준을 명확히 정의하세요."
                ),
            ),
            AgentRole(
                name="Executor",
            ...
            AgentRole(
                ...
                system_prompt=(
                    "당신은 검증자입니다. "
                    "실행 결과가 수용 기준을 충족하는지 검증하세요. "
                    "충족하면 'PASS'를, 수정이 필요하면 'REVISE'와 함께 "
                    "구체적 피드백을 제공하세요."
                ),
            ),
            AgentRole(
    ...
    "research-report": Pattern(
        ...
        roles=[
            ...
            AgentRole(
                ...
                system_prompt=(
                    "당신은 논리 검증자입니다. "
                    "연구 결과의 사실 관계와 논리를 검증하세요. "
                    "검증 통과 시 'PASS'를, "
                    "수정 필요 시 'REVISE'와 함께 피드백을 제공하세요."
                ),
            ),
            AgentRole(
                name="Reporter",
